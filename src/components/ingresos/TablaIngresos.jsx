  ...
  if (!rows?.length) {
    return (
      <div className="text-center py-12 text-sm text-gray-400 dark:text-gray-500">
        Sin ingresos registrados este mes. Agrega el primero.
      </div>
    )
  }
      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-gray-100 dark:border-gray-700">
            ...
            <th className="text-left py-3 px-2 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wide">Fuente</th>
            <th className="text-left py-3 px-2 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wide">Notas</th>
